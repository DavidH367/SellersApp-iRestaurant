  ...
  validateUploadForm() async {
    if(imageXFile != null)
    {
      if(shortInfoController.text.isNotEmpty && titleController.text.isNotEmpty)
      {
        ...
        //guardar informacino a firestore
      ...
      else
      {
        showDialog(
            ...
            {
              return ErrorDialog(
                message: "Porfavor ingrese la informacion completa del menu.",
              );
            }
        );
      }
    ...
    else
    {
      showDialog(
          ...
          {
            return ErrorDialog(
              message: "Porfavor seleccione una foto para el menu.",
            );
          }
      );
    }
