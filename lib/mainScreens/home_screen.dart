...
import 'package:login/widgets/info_design.dart';
import 'package:login/widgets/text_widget_header.dart';
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
         SliverPersistentHeader(pinned: true, delegate: TextWidgetHeader(title: "Mis Menus")),
